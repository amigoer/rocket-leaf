<div align="center">
  <picture>
    ...
    <img src="docs/images/hero-light.zh-CN.svg" width="100%" alt="MQ Studio — 本地优先的消息队列桌面客户端。一套界面连接 RocketMQ、RabbitMQ、Kafka、Pulsar、Redis Stream、MQTT、NATS、ActiveMQ、NSQ 与 Amazon SQS，更多驱动陆续接入，无需部署 Web 控制台。">
  </picture>
</div>
...
目前可以连接的驱动是 RocketMQ、RabbitMQ、Kafka、Pulsar、Redis Stream、MQTT、NATS、ActiveMQ、NSQ 和 Amazon SQS，其余进度见[驱动支持](#驱动支持)。
...
| Pub/Sub · Service Bus · Kinesis 等 | 📋 计划中 | 完整矩阵见下方折叠内容 |
