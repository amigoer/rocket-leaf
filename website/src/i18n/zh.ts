...
export const zh: Content = {
  ...
  meta: {
    ...
    description:
      'MQ Studio 是本地优先的消息队列桌面客户端，RocketMQ、RabbitMQ、Kafka、Pulsar、Redis Stream、MQTT、NATS、ActiveMQ、NSQ、Amazon SQS、Google Pub/Sub、Azure Service Bus、Amazon Kinesis、IBM MQ 与 Solace PubSub+ 共用同一套界面和操作，无需部署和值守 Web 控制台。支持 macOS、Windows、Linux，Apache-2.0 开源。',
  ...
  hero: {
    ...
    title: '一套界面，连接所有消息队列',
    subtitle:
      'MQ Studio 是本地优先的消息队列桌面客户端\u00a0—— RocketMQ、RabbitMQ、Kafka、Pulsar、Redis Stream、MQTT、NATS、ActiveMQ、NSQ、Amazon SQS、Google Pub/Sub、Azure Service Bus、Amazon Kinesis、IBM MQ 与 Solace PubSub+ 同一套界面、同一套操作，无需部署和值守 Web 控制台。',
